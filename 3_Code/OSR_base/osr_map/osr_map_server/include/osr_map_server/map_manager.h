...
public:
	...
	*/
	...
	bool overwrite_map(grid_map::GridMap _map, std::map<std::string, std::vector<std::string>> _layers_map);
	...
	*/
    ...
    bool project_map(const grid_map::GridMap& _lmap, const std::map<std::string, std::vector<std::string>>& _layers_map);
