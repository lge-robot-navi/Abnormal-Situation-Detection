...
from package import vggish_params as params


# weight path
WEIGHTS_PATH = 'package/vggish_audioset_weights_without_fc2.h5'
WEIGHTS_PATH_TOP = 'package/vggish_audioset_weights.h5'

def VGGish(load_weights=True, weights='audioset',
           input_tensor=None, input_shape=None,
           out_dim=None, include_top=True, pooling='avg', name=None):
    '''
    ...
    if input_tensor is not None:
        ...
        inputs = aud_input
    # Create model.
    model = Model(inputs, x, name='VGGish' + name)
