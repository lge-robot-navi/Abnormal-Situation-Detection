...
def parse_opts():
    ...
    parser.add_argument('--video_root', default='/media/zaigham/SSD_1TB/pohang_dataset/resized/train', type=str, help='Root path of input videos')
    ...
    parser.add_argument('--validation_video_root', default='/media/zaigham/SSD_1TB/pohang_dataset/resized/validation', type=str, help='validation data folder')
    parser.set_defaults(verbose=False)
