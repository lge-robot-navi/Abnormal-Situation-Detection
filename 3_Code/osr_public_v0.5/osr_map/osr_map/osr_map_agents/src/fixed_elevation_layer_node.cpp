/**
 * @file		fixed_elevation_layer_node.cpp
 * @date		Mar 22, 2019
 * @author  	Kiin Na (kina4147@etri.re.kr)
 * @brief   	This file includes main function for running fixed_elevation_layer_node
 * 				to build elevation layer of fixed agent
 * @remark
 * @warning
 *
...
{
  	// Node Generation
  	ros::init(argc, argv, "fixed_elevation_layer");
	...
	camera_rz = cx::cvtDeg2Rad(deg_rz);
  	...
  	osr_map::fixed_elevation_layer elevation_layer_node(nh, period, robot_id, robot_frame_id, map_frame_id);
  	elevation_layer_node.set_comm(layer_topic, pose_topic, depth_image_topic);
  	...
  	elevation_layer_node.set_distance_param(min_dist, max_dist);
  	elevation_layer_node.set_camera_param(camera_fx, camera_fy, camera_cx, camera_cy, camera_x, camera_y, camera_z, camera_rx, camera_ry, camera_rz);
