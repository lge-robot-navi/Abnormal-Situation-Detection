/**
 * @file		fixed_elevation_layer.h
 * @date		Mar 22, 2019
 * @author  	Kiin Na (kina4147@etri.re.kr)
 * @brief   	This file includes elevation_layer class for building and publishing elevation_layer of fixed agent by subscribing 3D point cloud and pose
 * @remark
 * @warning
 *
 ...
 */
#ifndef FIXED_ELEVATION_LAYER_H_
#define FIXED_ELEVATION_LAYER_H_
...
namespace osr_map{
	/**
	*  @class 			fixed_elevation_layer
	*  @brief 			This class builds and publish elevation_layer of fixed agent by subscribing 3D point cloud and pose
	*  @since			Mar 22, 2019
	*/
	class fixed_elevation_layer{
	public:
		fixed_elevation_layer(ros::NodeHandle _nh, int _period, int _robot_id, std::string _robot_frame_id, std::string _map_frame_id);
		~fixed_elevation_layer(){};
		/**
		* @fn		set_comm
...
#endif /* FIXED_ELEVATION_LAYER_H_ */
