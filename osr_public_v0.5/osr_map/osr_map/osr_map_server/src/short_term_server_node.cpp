...
#include "osr_map_comm/comp_comm.h"
#include "osr_map_comm/comp_packets.h"
#include "osr_map_comm/comp_converter.h"
...
//	boost::asio::io_service::work work(io_srv);
	osr_map::udp_sync_receiver receiver(io_srv, static_cast<unsigned int>(port));
//	receiver.start_receive();
//	boost::thread receive_thread = thread(boost::bind(&boost::asio::io_service::run, &io_srv));
	boost::thread receive_thread(boost::bind(&osr_map::udp_sync_receiver::receive_loop, &receiver));
