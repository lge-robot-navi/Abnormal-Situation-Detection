 ...
 * @brief   	This file includes udp_receiver, udp_sender, udp_receiver, and udp_sender class
...
//		tmp_msgs.erase(tmp_msgs.begin(), tmp_msgs.end());
	...
	*/
	...
	bool get_new_message(osr_map::light_layered_map& _msg)
	{
